...
ode = @ODEmodel(
    ...
    x9'(t) = 0.275*t23*x11(t)/0.4 - x9(t)*(t22/t25)*(x2(t)+x3(t)+x4(t)+x5(t))/((x25(t)*t17/t15)+1) - x9(t)*t21*((x5(t)+x3(t))^2)/((x18(t)*t3/(t1 +1))*((x25(t)*t17/t15)+1)*(t25^2)),
    ...
    x11'(t) = 0.4*t24*x10(t)/0.275 - t23*x11(t),
    ...
    x17'(t) = x16(t)*t4*0.275/0.4 - x17(t)*t5,
    ...
    x24'(t) = 0.275*x23(t)*t18/0.4 - x24(t)*t19,
...
@time println(assess_local_identifiability(ode))
