...
sigma := [
  diff(x1(t), t) = -t1*x1(t)*c1*u(t) - t5*x1(t) + t6*x2(t),
  diff(x2(t), t) = t5*x1(t)-t6*x2(t),
  diff(x3(t), t) = t1*c1*u(t)*x1(t)-t2*x3(t)*(-x6(t)+2.8),
  diff(x4(t), t) = t2*x3(t)*(-x6(t)+2.8) - t3*x4(t),
  diff(x5(t), t) = t3*x4(t)-t4*x5(t),
  diff(x6(t), t) = -t7*x3(t)*x6(t)/(1+t13*x1(t))-t7*x4(t)*x6(t)/(1+t13*x10(t))+t8*(-x6(t)+2.8)*c2,
  diff(x7(t), t) = -t9*x7(t)*(-x6(t)+2.8)+t10*(-x7(t)+165)*c2,
  diff(x8(t), t) = t11*(-x7(t)+165),
  diff(x9(t), t) = -t12*c1*u(t)*x9(t),
