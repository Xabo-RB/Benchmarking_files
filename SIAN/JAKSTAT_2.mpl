...
sys := [
  ...
  diff(x9(t), t) = (1/4)*t23*x11(t)/(2/5) - x9(t)*(t22/t25)*(x2(t)+x3(t)+x4(t)+x5(t))/((x25(t)*t17/t15)+1) - x9(t)*t21*((x5(t)+x3(t))^2)/((x18(t)*t3/(t1 +1))*((x25(t)*t17/t15)+1)*(t25^2)),
  ...
  diff(x11(t), t) = (2/5)*t24*x10(t)/(1/4) - t23*x11(t),
  ...
  diff(x17(t), t) = x16(t)*t4*(1/4)/(2/5) - x17(t)*t5,
  ...
  diff(x24(t), t) = (1/4)*x23(t)*t18/(2/5) - x24(t)*t19,
