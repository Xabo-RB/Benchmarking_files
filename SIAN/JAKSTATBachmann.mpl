...
sigma := [
  diff(x1(t), t) = (x2(t)+x3(t)+x4(t)+x5(t))*x8(t)*t11/t26 - k5*x1(t)*t10/((x25(t)*t17/t15)+1),
  diff(x2(t), t) = k5*x1(t)*t10/((x25(t)*t17/t15)+1) - x2(t)*t7/((x25(t)*t17/t15)+1) - x2(t)*x8(t)*t11/t26 - 3*x2(t)*t7/((t8*x6(t)+1)*((x25(t)*t17/t15)+1)),
  ...
  diff(x12(t), t) = -x12(t)*t4 - t5*x11(t)*(k1-1)/t27,
  ...
  diff(x18(t), t) = x17(t)*t1*t6 - x18(t)*t6 +k2*t6*t2*t1,
  diff(x19(t), t) = -x19(t)*t18 - t19*x11(t)*(k1-1)/t27,
  ...
  diff(x25(t), t) = x24(t)*t15*t20 - x25(t)*t20 + k3*t20*t16*t15, 
