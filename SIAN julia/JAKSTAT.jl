...
ode = @ODEmodel(
    x1'(t) = -t1*x1(t)*2.265*u(t) - t5*x1(t) + t6*x2(t),
    x2'(t) = t5*x1(t)-t6*x2(t),
    x3'(t) = t1*2.265*u(t)*x1(t)-t2*x3(t)*(-x6(t)+2.8),
    x4'(t) = t2*x3(t)*(-x6(t)+2.8) - t3*x4(t),
    x5'(t) = t3*x4(t)-t4*x5(t),
    x6'(t) = -t7*x3(t)*x6(t)/(1+t13*x1(t))-t7*x4(t)*x6(t)/(1+t13*x10(t))+t8*(-x6(t)+2.8)*92,
    x7'(t) = -t9*x7(t)*(-x6(t)+2.8)+t10*(-x7(t)+165)*92,
    x8'(t) = t11*(-x7(t)+165),
    x9'(t) = -t12*2.265*u(t)*x9(t),
